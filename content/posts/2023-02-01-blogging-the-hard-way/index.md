...
![Using Drafts.app](images/drafts.png)

Pushing changes (articles) to the Git server, and voilà!

![My Blog](images/my-blog.png)
...
![Blog Repo on Gitea](images/starbops-blog-gitea.png)
...
![Drone Settings](images/drone-blog-settings.png)

### Final Integration

![Pushing Commits](images/pushing-commits.png)

![PR Merge](images/pr-merge.png)

![Pushing Tags](images/pushing-tags.png)
